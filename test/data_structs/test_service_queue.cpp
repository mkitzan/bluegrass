...
bool test_ende_queues() 
{
	I = 0;
	char data;
	service<char, queue_t::DEQUEUE> dq(create_test0, 4);
	service<char, queue_t::ENQUEUE> eq(utilize_test, 4);
...
{
	I = 0;
	service<char, queue_t::NOQUEUE> no(create_test1, utilize_test, 4, 4);
